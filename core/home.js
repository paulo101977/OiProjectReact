...
function onIndex(){
    ...
    $("#password").popover({
        ...
        'placement' : 'bottom',
        'target' : '#password',
        'content' : "Deve ter entre 6 e 10 caracteres, com letras e números"
    })
    ...
    $(".item-last").click(function(){
        ...
        window.location.replace("localhost:3000/cpf");
    })
}
...
$(document).ready(function(){
   ...
   animatePage(path);
    ...
    if(containerWidth < 768){
        ...
        if($.fn.fullpage && $.fn.fullpage.setAutoScrolling) $.fn.fullpage.setAutoScrolling(false);
        $('#fullpage').css('height','calc(100vh - 70px)');
    } else {
        //enable auto scroll on desktop device
        if($.fn.fullpage && $.fn.fullpage.setAutoScrolling) $.fn.fullpage.setAutoScrolling(true);
